...
import {projects} from '../../assets/Data_Analyst_Data/DData'


const DProjects = ({setNavState}) => {

    const navigate = useNavigate()

    const handleBack = () => {
      navigate('/data-analyst')
      setNavState('data-analyst')
    }
      ...
      <div className="min-h-screen pt-16">
        ...
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="section-title">Projects & Coursework</h2>
            <p className="section-subtitle">
              ...
              >
                ...
                <div className="flex gap-3">
                  ...
                  {/* <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    href={project.live}
                    className="flex-1 bg-transparent border-2 border-text-light text-text-light hover:bg-text-light hover:text-white text-center py-2 px-4 rounded-lg transition-colors duration-300 flex items-center justify-center gap-2"
                  >
